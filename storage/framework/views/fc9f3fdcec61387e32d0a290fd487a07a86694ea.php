...
<div id="tabla">
  <?php echo $__env->make('alumno.tabla', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>;
</div>
...
<?php echo $__env->make('adminlte::layouts.appAlumno', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>