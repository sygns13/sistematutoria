...
function enviarEnter(ele,e) {
  ...
  var token=$("#tokenLaravel").val();
   ...
   $.post("HomeController/cargarMsjs", { v1:idTA, _token:token })
  .done(function(data) {
...
function enviarMsj() {
 ...
 $.post("HomeController/enviarChat", { v1:idTA, v2:mensaje, _token:token })
  .done(function(data) {
...
function chatAlumno(v1,v2,v3,v4) {
    var token=$("#tokenLaravel").val();
  $.post("HomeController/cargarChat", { idP: v1, idA: v2, idU:v3, idTA:v4, _token:token })
  .done(function(data) {



    $("#divChat").empty();
    $("#divChat").html(data.view);
