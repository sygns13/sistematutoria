            ...
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <?php $__currentLoopData = $diagnostico; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $diag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <input type="hidden" name="txtidDiag" id="txtidDiag" value="<?php echo e($diag->id); ?>">
                 <div class="form-group">
                  <label for="txtAsuntoD">Título o Asunto:</label>
                  <input type="text" class="form-control" id="txtAsuntoD" name="txtAsuntoD" placeholder="Ingrese Asunto" onkeyup="EscribeLetras(event,this);" value="<?php echo e($diag->nomdiag); ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <textarea id="txtContenido" name="txtContenido" class="form-control" rows="6"><?php echo e($diag->descripcion); ?></textarea>
