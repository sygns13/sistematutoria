      <?php $__currentLoopData = $tutor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dato): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="box box-info" style="border-bottom: 0px;">
          ...
          Volver</button>
                  ...
                  <input type="hidden" id="idPerEdit" value="<?php echo e($dato->idper); ?>">
                  <input type="hidden" id="idTutEdit" value="<?php echo e($dato->idtutor); ?>">
                  <input type="hidden" id="idUsuEdit" value="<?php echo e($dato->idusu); ?>">
