            ...
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="txtAlum" name="txtAlum" placeholder="Alumno" readonly="true" onkeypress="return noEscribe(event);" value="<?php echo e($dato->nombres); ?> <?php echo e($dato->apellidos); ?>"> 
                </div>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="cbsEvalDiag">
                    <?php echo $__env->make('adminlte::cbsEvalTarea', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                  </select>
