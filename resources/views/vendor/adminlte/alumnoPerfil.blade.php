            ...
            <form class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="txtcodE" placeholder="Código" value="{{$dato->codigo}}" readonly="true" onkeypress="return noEscribe(event);">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="txtDNIE" placeholder="DNI" value="{{$dato->DNI}}" onkeypress="return soloNumeros(event);" readonly="true" onkeypress="return noEscribe(event);">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="txtnomE" placeholder="Nombres" value="{{$dato->nombres}}" readonly="true" onkeypress="return noEscribe(event);">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="txtapeE" placeholder="Apellidos" value="{{$dato->apellidos}}" readonly="true" onkeypress="return noEscribe(event);">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="txtsemeE" placeholder="I,II,..." value="{{$dato->semestre}}" readonly="true" onkeypress="return noEscribe(event);">
                  </div>
                </div>
