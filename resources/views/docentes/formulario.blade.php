 ...
 <div class="form-group">
              ...
              {{--     <div class="alert alert-info alert-dismissible">
                ...
                Copie Adecuadamente el Iframe del video de Youtube, o deje el espacio en blanco.
              </div>--}}
            ...
            <img src="{{ asset('/img/av3.png')}}" id="imgPerfil" class="profile-user-img img-responsive img-circle" alt="Imagen del usuario" style="height: 80px;width: 80px;" id="imgEdit" />
